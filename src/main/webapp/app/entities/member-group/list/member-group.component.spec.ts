...
import { sampleWithRequiredData } from '../member-group.test-samples';
...
describe('MemberGroup Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(MemberGroupComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.memberGroups?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to memberGroupService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getMemberGroupIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMemberGroupIdentifier).toHaveBeenCalledWith(entity);
