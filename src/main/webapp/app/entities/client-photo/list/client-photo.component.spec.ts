...
import { sampleWithRequiredData } from '../client-photo.test-samples';
...
describe('ClientPhoto Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ClientPhotoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.clientPhotos?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to clientPhotoService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getClientPhotoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getClientPhotoIdentifier).toHaveBeenCalledWith(entity);
