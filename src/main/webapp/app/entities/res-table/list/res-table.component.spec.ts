...
import { sampleWithRequiredData } from '../res-table.test-samples';
...
describe('ResTable Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ResTableComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.resTables?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to resTableService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getResTableIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getResTableIdentifier).toHaveBeenCalledWith(entity);
